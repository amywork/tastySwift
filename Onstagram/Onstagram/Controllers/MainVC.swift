...
class MainVC: UIViewController {
    ...
    private func setupLayout() {
        ...
        profileImgView.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor, constant: 24).isActive = true
...
extension MainVC {
    ...
    func showImagePicker() {
        let imagePickerController = ImagePickerVC.viewController
